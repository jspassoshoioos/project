...
following demographic information, presented below in tabular format.
...
The City of Chicago's population in 2010 was 2.6 million, and this estimates
2.4 million so we are fairly close, a tract or two along the edges may have been
excluded, but the bulk of the city's population is here in the data set. Now 
that we have the data, we will begin with some basic plots of the percent 
