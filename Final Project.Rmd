...
plot_4.1 <- ggplot() +
  ...
  geom_hline(yintercept = mean(Cer_Chi2$Cer_Chi_bef), color = "#c60c30", alpha = 0.5) + 
  xlab("Number of Months Before/After Project") + 
  ylab("Mean # of Riders") +
...
plot_4.2 <- ggplot() +   
  ...
  geom_hline(yintercept = mean(System_Cermak2$before_mean), color = "Black", alpha = 0.5) + 
  xlab("Number of Months Before/After Project") + 
  ylab("Mean # of Riders") +
...
plot_7.1 <- ggplot() +
  geom_hline(data = DanRyan, aes(yintercept = mean(DanRyan$Dan_bef), color = "#c60c30", alpha = 0.5)) + 
  geom_hline(data = DanRyan, aes(yintercept = mean(DanRyan$Dan_aft), color = "#f598a9", alpha = 0.5)) +
