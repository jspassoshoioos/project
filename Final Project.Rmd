...
were determined from [this map](https://www.csu.edu/cerc/documents/ChicagoCommunityAreasMapWithCensusTracts2000-NIPC.pdf) published by the Northeastern Illinois Planning Commission. 
...
percents  %>%
  ...
  kable(col.names = c("Area",
                      "English Only", "Non-Native English", "Primary Not Eng", "Spanish"), 
        align = "ccc", 
...
```{r}
ggplot() +
  geom_hline(yintercept = mean(Cer_Chi2$perc_mean), color = "#c60c30", alpha = 0.5) + # Include average lines to help see average despite variation 
  geom_hline(yintercept = mean(System_Cermak2$perc_mean), color = "Black", alpha = 0.5) +
  geom_line(data = Cer_Chi2, aes(x = month, y = perc_mean, group = 1, color = "#c60c30")) +
  geom_point(data = Cer_Chi2, aes(x = month, y = perc_mean, group = 1, color = "#c60c30")) +
  geom_line(data = System_Cermak2, aes(x = month, y = perc_mean), color = "Black", group = 1) +
  geom_point(data = System_Cermak2, aes(x = month, y = perc_mean, group = 1, color = "Black")) + 
  labs(title = "Cermak-Chinatown vs. System Wide",
       subtitle = "Before February 2008 and After February 2009", 
       caption = "Source: Chicago Transit Authority Daily Ridership Dataset via Chicago Data Portal") +
  xlab("Number of Months Before/After Project") + 
  ylab("% Change in Mean Ridership") +
  scale_color_manual(name = "Station", 
...
a <- ggplot() +
  geom_line(data = Cer_Chi, aes(x = month, y = Cer_Chi_bef, group = 1, color = "#e89bab")) +
  geom_point(data = Cer_Chi, aes(x = month, y = Cer_Chi_bef, group = 1, color = "#e89bab")) + 
  geom_line(data = Cer_Chi, aes(x = month, y = Cer_Chi_aft, group = 1), color = "#c60c30") +
  geom_point(data = Cer_Chi, aes(x = month, y = Cer_Chi_aft, group = 1, color = "#c60c30"))  + 
  scale_color_manual(name = "Time", 
                    labels = c("After", "Before"), 
                    values = c("#c60c30", "#e89bab")) +
  labs(title = "Cermak-Chinatown") +
  xlab("Number of Months Before/After Project") + 
  ylab("Mean # of Riders") +
  red_line
...
b <- ggplot() + 
  geom_line(data = System_Cermak, aes(x = month, y = before_mean, group = 1, color = "Gray")) +
  geom_point(data = System_Cermak, aes(x = month, y = before_mean, group = 1, color = "Gray")) +
  geom_line(data = System_Cermak, aes(x = month, y = after_mean), 
            color = "Black", group = 1) +
  geom_point(data = System_Cermak, aes(x = month, y = after_mean, group = 1, color = "Black")) +
  scale_color_manual(name = "Time", 
                    labels = c("After", "Before"), 
                    values = c("Black", "Gray")) + 
  labs(title = "System-Wide") +
...
plot_7 <- ggplot() +
  geom_hline(yintercept = mean(DanRyan$perc_mean), color = "#c60c30", alpha = 0.5) +
  geom_hline(yintercept = mean(System_DanRyan$perc_mean), color = "Black", alpha = 0.5) +
  geom_line(data = DanRyan, aes(x = month, y = perc_mean, group = 1, color = "#c60c30")) +
  geom_point(data = DanRyan, aes(x = month, y = perc_mean, group = 1, color = "#c60c30")) +
  geom_line(data = System_DanRyan, aes(x = month, y = perc_mean), group = 1, color = "Black") +
...
<<<<<<< HEAD
  ...
  geom_hline() +
=======
  geom_hline(yintercept = mean(DanRyan$Dan_bef), color = "#e89bab") +
  geom_hline(yintercept = mean(DanRyan$Dan_aft), color = "#c60c30") +
  geom_line(data = DanRyan, aes(x = month, y = Dan_bef, group = 1, color = "#e89bab")) +
  geom_point(data = DanRyan, aes(x = month, y = Dan_bef, group = 1, color = "#e89bab")) +
>>>>>>> fe8236e56fe926173b596b7e1e1a2c70b0d55d33
  geom_line(data = DanRyan, aes(x = month, y = Dan_aft), 
            group = 1, color = "#c60c30") +
  geom_point(data = DanRyan, aes(x = month, y = Dan_aft, color = "#c60c30"), 
            group = 1) + 
  labs(title = "95th/Dan Ryan vs. System Wide",
       subtitle = "Difference in the average number of riders for the 12 month period before March 2017 and after January 2019",
       caption = "Source: Chicago Transit Authority Daily Ridership Dataset via Chicago Data Portal") +
  xlab("Number of Months Before/After Project") + 
  ylab("Mean # of Riders") +
...
```{r System B&A Total rides, include=T}
plot_7.2 <- ggplot() +
