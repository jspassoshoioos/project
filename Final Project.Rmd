...
plot_4 <- ggplot() +
  geom_line(data = Cer_Chi, aes(x = month, y = perc_mean, group = 1), 
            color = "Red") +
  geom_point(data = Cer_Chi, aes(x = month, y = perc_mean, group = 1), color = "Red") +
  geom_line(data = System_Cermak, aes(x = month, y = perc_mean), 
            color = "Black", group = 1) +
  geom_point(data = System_Cermak, aes(x = month, y = perc_mean, group = 1), color = "Black") + 
  scale_y_continuous(limits = c(0, 30)) +
  geom_hline(yintercept = mean(Cer_Chi$perc_mean), color = "Red") + # Include average lines to help see average despite variation 
  geom_hline(yintercept = mean(System_Cermak$perc_mean), color = "Black")
...
plot_4.1 <- ggplot() +
  geom_line(data = Cer_Chi2, aes(x = month, y = Cer_Chi_bef, group = 1), 
            color = "Red") +
  geom_point(data = Cer_Chi2, aes(x = month, y = Cer_Chi_bef, group = 1), color = "Red") +
   geom_hline(yintercept = mean(Cer_Chi2$Cer_Chi_bef), color = "Red") 
...
ggplot() +
  geom_line(data = Cer_Chi2, aes(x = month, y = perc_mean, group = 1), 
            color = "Red") +
  geom_point(data = Cer_Chi2, aes(x = month, y = perc_mean, group = 1), color = "Red") +
  ...
  geom_hline(yintercept = mean(Cer_Chi2$perc_mean), color = "Red") + # Include average lines to help see average despite variation 
...
a <- ggplot() +
  geom_line(data = Cer_Chi, aes(x = month, y = Cer_Chi_bef, group = 1), 
            color = "#ff9494") +
  geom_point(data = Cer_Chi, aes(x = month, y = Cer_Chi_bef, group = 1), color = "#ff9494") + 
  geom_line(data = Cer_Chi, aes(x = month, y = Cer_Chi_aft, group = 1), 
            color = "#fa0000") +
  geom_point(data = Cer_Chi, aes(x = month, y = Cer_Chi_aft, group = 1), color = "#fa0000")  
  
b <- ggplot() + 
  geom_line(data = System_Cermak, aes(x = month, y = before_mean, group = 1), color = "#d1d1d1") +
  geom_point(data = System_Cermak, aes(x = month, y = before_mean, group = 1), color = "#d1d1d1") +
  geom_line(data = System_Cermak, aes(x = month, y = after_mean), 
            color = "#000000", group = 1) +
  geom_point(data = System_Cermak, aes(x = month, y = after_mean, group = 1), color = "#000000") 
...
station seeing a decrease in ridership trends as well, though less dramatic. Future
